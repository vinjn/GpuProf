...
class PrimitiveDataflowGenerator:
    ...
    def __init__(gen):
        ...
        gen.rows = [
            ...
            gen.Row('Vertex Shader'                     , 'NotApplicable'           , 'sm__threads_launched_shader_vs'      , 'NotAvailable'            , 'NotApplicable'                       , 'NotApplicable'                   , 'sm__threads_launched_shader_vs'  , 'NotApplicable'               ),
